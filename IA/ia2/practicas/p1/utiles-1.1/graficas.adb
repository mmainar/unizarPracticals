...
with Textos, Text_IO, Ada.Integer_Text_IO, Ada.Float_Text_IO;
use  Textos, Text_IO, Ada.Integer_Text_IO, Ada.Float_Text_IO;
...
package body Graficas is
  ...
  begin
    ...
    bx := 0.1*(xmax2-xmin);
    by := 0.1*(ymax2-ymin);
    -- Ir - 2007 This function call causes a crash under GNU/Linux
    -- Space (Xwin, xmin-bx,ymin-by,xmax2+bx,ymax2+by);
    Space (Xwin, xmin,ymin,xmax2,ymax2);
    fs := Font_Size(Xwin);
