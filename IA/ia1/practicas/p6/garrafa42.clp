...
=>
	(assert (estado (jarra3 (- ?cantidad3 (min ?cantidad3 (- 4 ?cantidad4))))
                        (jarra4 (+ ?cantidad4 (min ?cantidad3 (- 4 ?cantidad4))))
			        (profundidad (+ ?profundidad 1))
			        (padre ?estado)
...
=>
	(assert (estado (jarra4 (- ?cantidad4 (min ?cantidad4 (- 3 ?cantidad3))))
                        (jarra3 (+ ?cantidad3 (min ?cantidad4 (- 3 ?cantidad3))))
			        (profundidad (+ ?profundidad 1))
			        (padre ?estado)
