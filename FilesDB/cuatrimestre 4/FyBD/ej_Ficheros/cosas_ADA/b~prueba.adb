pragma Source_File_Name (ada_main, Spec_File_Name => "b~prueba.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~prueba.adb");
...
package body ada_main is
   ...
   procedure adainit is
      ...
      E094 : Boolean; pragma Import (Ada, E094, "interfaces__c_E");
      ...
      E092 : Boolean; pragma Import (Ada, E092, "uso_sistema_E");

      Restrictions : constant String :=
        "nnvvnnnvnnnnnvvvvvvnvvvnvnnvnnnvnvvnnnnnnvvvvnnnvvnn";
...
-- BEGIN Object file/option list
   ...
   --   ./prueba.o
   --   -L./
   --   -LC:\DOCUME~1\MARCOS~1\ESCRIT~1\ASIGNA~1\CUATRI~1\FyBD\EJ_FIC~1\COSAS_~1\
