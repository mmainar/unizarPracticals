...
;     el resultado en la medida de lo posible. A continuacion se muestran
;     algunos ejemplos:
;
;     USER(3): (d '’x '’(+ x (+ 3 x)))
;        (2)
;     USER(4): (d '’x '’(* x 3))
;        (3)
; USER(2): (derivada ’'x ’'(- x (* 3 x)))
;   (2)
; USER(5): (derivada '’y '’(+ y (* x y)))
;  (+ 1 x)

; Nota: a es la variable respecto a la cual derivamos y b
;       es la expresion simbolica a derivar.

(defun s (b) ; Funcion de simplificaciones
 (cond 
 ((and (eql (first b) '*) (eql (nth 1 b) '0)) 0)
 ((and (eql (first b) '*) (eql (nth 2 b) '0)) 0)
 ((and (eql (first b) '+) (eql (nth 2 b) '0)) (nth 1 b))
 ((and (eql (first b) '+) (eql (nth 1 b) '0)) (nth 2 b))
 ...
 ;((and (eql (first b) '-) (numberp (nth 1 b)) (numberp (nth 2 b)) (< (nth 1 b) (nth 2 b))
 ; (- (nth 2 b) (nth 1 b))))
 ((and (eql (first b) '*) (eql (nth 1 b) '1)) (nth 2 b))
 ((and (eql (first b) '*) (eql (nth 2 b) '1)) (nth 1 b))
 ((and (eql (first b) '*) (numberp (nth 1 b)) (numberp (nth 2 b)) (* (nth 1 b) (nth 2 b))))
 ((and (eql (first b) '/) (eql (nth 1 b) '0)) 0)
 ((and (eql (first b) '/) (numberp (nth 1 b)) (numberp (nth 2 b)) (/ (nth 1 b) (nth 2 b))))
 ((and (eql (first b) '/) (eql (nth 2 b) '1)) (nth 1 b))
...
(defun d (b a)  ; funcion que calcula la derivada (+, -, *, /, sen, cos, tan).
 ...
 ;((and (eql (first b) '*) (numberp (nth 1 b))) (* (nth 1 b) (d (nth 2 b) a)))
 ;((and (eql (first b) '*) (numberp (nth 2 b))) (* (nth 2 b) (d (nth 1 b) a)))

 ((eql (first b) '+) (s (cons '+ (append (list (d (nth 1 b) a)) (list (d (nth 2 b) a))))))

 ((eql (first b) '-) (s (cons '- (append (list (d (nth 1 b) a)) (list (d (nth 2 b) a))))))

 ((eql (first b) '*) (s (cons '+ (append (list (s (cons '* (append (list (d (nth 1 b) a)) (list (nth 2 b)))))) (list (s (cons '* (append (list (nth 1 b)) (list (d (nth 2 b) a))))))))))
 ...
 ((eql (first b) 'cos) (s (cons '* (append (list (cons '-sin (list (nth 1 b))))
                     (list (d (nth 1 b) a))))))
		     
 ((eql (first b) '-cos) (s (cons '* (append (list (cons 'sin (list (nth 1 b))))
                     (list (d (nth 1 b) a))))))
		      
 ((eql (first b) 'tan) (s (cons '/ (append (list (d (nth 1 b) a)) (list (cons '* (append (list (cons 'cos (list (nth 1 b)))) (list (cons 'cos (list (nth 1 b)))))))))))))
