...
loopUnroll="+Oloop_unroll="$2 # [=n] Desenrolla bucles, se puede especificar grado n
...
echo "--------------------------------------------------------------------------------"
echo "Compilamos (Secuencial)..."
echo f90 -O4 $OpcionesComp $OpcionesParallel $OpcionesInfo $1.f90 -o $1 -L. -lpresum 
echo "--------------------------------------------------------------------------------"

f90 -O4 $OpcionesComp $OpcionesParallel $OpcionesInfo $1.f90 -o $1 -L. -lpresum
