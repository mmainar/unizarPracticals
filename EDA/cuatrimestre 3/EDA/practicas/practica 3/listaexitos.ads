...
--|
--|   ecuaciones c,c1,c2: canción; l: lista; f:fecha; cot: cota;
--|      (c1=c2) <-> (titulo(c1)=titulo(c2)) ^ (interprete(c1)=interprete(c2))
--|                 ^ (tiempo(c1)=tiempo(c2))
--|      c1/=c2 -> AÑADIR(AÑADIR(l,c1),c2) = AÑADIR(AÑADIR(l,c2),c1)
--|      c1=c2  -> AÑADIR(AÑADIR(l,c1),c2) = AÑADIR(l,c2)
...
--|
  ...
  -- Solicita el nombre de un fichero de texto y almacena en él la
